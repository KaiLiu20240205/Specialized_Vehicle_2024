...
if("TRUE" STREQUAL "TRUE")
  set(calibration_camera_lidar_SOURCE_PREFIX /home/kai/catkin_ws/src/calibration_camera_lidar/ls_calibration/calibration_camera_lidar)
  set(calibration_camera_lidar_DEVEL_PREFIX /home/kai/catkin_ws/devel)
  ...
  set(calibration_camera_lidar_INSTALL_PREFIX /home/kai/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'calibration_camera_lidar' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'calibration_camera_lidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kai/catkin_ws/src/calibration_camera_lidar/ls_calibration/calibration_camera_lidar/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT calibration_camera_lidar_NUM_DUMMY_TARGETS)
      set(calibration_camera_lidar_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::calibration_camera_lidar::wrapped-linker-option${calibration_camera_lidar_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR calibration_camera_lidar_NUM_DUMMY_TARGETS "${calibration_camera_lidar_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::calibration_camera_lidar::wrapped-linker-option${calibration_camera_lidar_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND calibration_camera_lidar_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kai/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
set(depends "roscpp;rosconsole;std_msgs;sensor_msgs;glviewer;rosinterface;cv_bridge;pcl_ros;image_transport;autoware_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${calibration_camera_lidar_dep}_FOUND)
      find_package(${calibration_camera_lidar_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${calibration_camera_lidar_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
