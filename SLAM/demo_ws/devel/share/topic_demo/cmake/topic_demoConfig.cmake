...
if("TRUE" STREQUAL "TRUE")
  set(topic_demo_SOURCE_PREFIX /home/fengcong/Specialized_Vehicle_2024/SLAM/demo_ws/src/topic_demo)
  set(topic_demo_DEVEL_PREFIX /home/fengcong/Specialized_Vehicle_2024/SLAM/demo_ws/devel)
  ...
  set(topic_demo_INSTALL_PREFIX /home/fengcong/Specialized_Vehicle_2024/SLAM/demo_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'topic_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fengcong/Specialized_Vehicle_2024/SLAM/demo_ws/src/topic_demo/${idir}'.  ${_report}")
    endif()
...
set(topic_demo_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(topic_demo_EXPORTED_TARGETS ${${topic_demo_dep}_EXPORTED_TARGETS})
endforeach()
